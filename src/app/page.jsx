...
const usersData = [
  { id: 1, name: 'Alex', age: 28, image: 'https://picsum.photos/300/400?1' },
  { id: 2, name: 'Sarah', age: 24, image: 'https://picsum.photos/300/400?2' },
  { id: 3, name: 'Michael', age: 30, image: 'https://picsum.photos/300/400?3' },
  { id: 4, name: 'Emma', age: 26, image: 'https://picsum.photos/300/400?4' },
]
  ...
  if (currentIndex >= users.length) {
    return (
      <div style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <button onClick={() => { setUsers(usersData); setCurrentIndex(0); setActions([]) }}>
          Reset
        </button>
      </div>
    )
    ...
    return (
      <motion.div
        style={{
          ...
          translateY: stackIndex * 10, // <-- use translateY instead of top
          zIndex: isTop ? 100 : 10 - stackIndex, // top card has highest z-index
        }}
        drag={isTop ? 'x' : false}
